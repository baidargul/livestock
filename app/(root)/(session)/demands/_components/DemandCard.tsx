...
const DemandCard = (props: Props) => {
    ...
    return (
        <Link href={`/demands/${demand.id}`}>
            <div className={`cursor-pointer select-none p-2 bg-white rounded drop-shadow-sm ${demand.user.id === props.user?.id ? "bg-gradient-to-t from-emerald-50 to-transparent" : ""}`}>
