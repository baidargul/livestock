...
const SoldOverlay = (props: Props) => {
    ...
    return (
        <div className='w-full h-full relative'>
            {props.children}
            {animal?.sold && <div className='absolute bottom-0 left-0 z-[1] pointer-events-none w-full h-full bg-gradient-to-t from-white to-transparent flex justify-center items-center'>
