...
const Checkbox = (props: Props) => {
    ...
    return (
        <div onClick={handleChange} className='flex gap-1 select-none group items-center cursor-pointer relative'>
            ...
            <label className='cursor-pointer text-nowrap label'>{props.label}</label>
        </div>
    )
}
