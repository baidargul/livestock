...
const SectionLandingPageImage = (props: Props) => {
    return (
        <div className='relative w-full max-h-[230px] flex justify-center items-center overflow-hidden select-none'>
            ...
            <Image src={images.chickens.covers[1]} priority layout='fixed' alt='livestock' draggable={false} width={406} height={195} quality={70} className='w-full max-h-[230px] h-full rounded-xl object-cover' />
        </div>
    )
}
