...
const ProductSearchBar = (props: Props) => {
    ...
    return (
        <>
            <div className='flex w-full gap-2 items-center px-4 mb-4 z-[2]'>
            ...
            {searchCriteria.length > 0 && <div onClick={() => setSearchCriteria('')} className='inset-0 fixed w-full h-full z-[1]'></div>}
        </>
    )
}
