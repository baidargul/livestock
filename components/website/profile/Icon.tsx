...
const UserProfileIcon = (props: Props) => {
    ...
    return (
        <div>
            <ProfileMenuWrapper>
                <Image src={currentUser && currentUser.profileImage && currentUser.profileImage.length > 0 ? currentUser.profileImage[0].image : images.site.placeholders.userProfile} width={40} height={40} layout='fixed' loading='lazy' quality={100} alt='janwarmarkaz' className='rounded-full object-cover w-10 h-10' />
            </ProfileMenuWrapper>
        </div>
    )
}
