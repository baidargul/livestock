...
const MenuWrapper = ({ handleToggleMenu, isToggled }: any) => {
    ...
    return (
        <div className={`fixed top-0 right-0 w-full h-full bg-white z-20 p-2 transition-all duration-200 ease-in-out ${isToggled ? "translate-x-0" : "translate-x-full"}`}>
            <div>
                ...
                <div className='flex flex-col'>
                    ...
                    <div className='grid grid-cols-2 gap-2'>
                        <div className='cursor-pointer mt-5 p-4 flex gap-2 justify-between bg-white rounded-xl drop-shadow-sm items-center'>
