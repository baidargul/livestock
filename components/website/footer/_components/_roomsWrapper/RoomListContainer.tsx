...
const RoomListContainer = (props: Props) => {
    return (
        <>
            ...
            <div className={`w-[90%] sm:w-[40%] select-none transition-all duration-200 z-50 ease-out h-full fixed right-0 ${props.isToggled ? "translate-x-0" : " translate-x-full"} top-0 bg-white`}>
