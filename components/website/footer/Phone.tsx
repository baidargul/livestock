...
const PhoneFooter = (props: Props) => {
    ...
    return (
        <div className='mt-10 bg-zinc-100 border-t border-zinc-200 text-zinc-600 select-none z-50 sticky bottom-0 left-0 w-full h-14 flex justify-evenly items-center'>
            <FetchLastestRooms />
            <Link href={'/home'}>
