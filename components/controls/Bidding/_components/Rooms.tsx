          ...
          >
            <div className="flex gap-4 items-center">
              ...
              <div>
                ...
                <div className="text-xs text-zinc-700">{bid.city ? `${formalizeText(bid.city)}, ${formalizeText(bid.province)}` : `${formalizeText(bid.user.city)}, ${formalizeText(bid.user.province)}`}</div>
              </div>
            </div>
