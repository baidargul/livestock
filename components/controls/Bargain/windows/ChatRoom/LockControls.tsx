    ...
    return (
        <div className='text-sm tracking-tight text-left mt-4 flex flex-col gap-4'>
            ...
            <div className='flex justify-evenly gap-2 items-center'>
                <div onClick={async () => { props.handleLockOffer(props.message) }} className={`${props.isLockingOffer ? "pointer-events-none" : "pointer-events-auto"} p-1 px-2 cursor-pointer hover:bg-emerald-50 border border-emerald-600 w-full rounded text-center`}>{props.isLockingOffer ? "..." : "Yes"}</div>
