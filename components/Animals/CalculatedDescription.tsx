                        ...
                        <tr>
                            ...
                            <td className="py-2">
                                <div className="flex flex-col">
                                    ...
                                    {animal.deliveryOptions.includes("SELLER_DELIVERY") && Number(animal.cargoPrice) > 0 && <span className='mt-2'>{formatCurrency(Number(animal.cargoPrice))} Cargo</span>}
                        ...
                        <tr>
                            ...
                            <td className="py-2">
                                <div className="flex flex-col">
                                    ...
                                    {animal.deliveryOptions.includes("SELLER_DELIVERY") && Number(animal.cargoPrice) > 0 && <span className='mt-4'>{formatCurrency(Number(animal.cargoPrice))} Cargo</span>}
                                    <span className="font-semibold">
